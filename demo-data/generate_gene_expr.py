...
# Read the TSV file
df = pd.read_csv('/Users/minghao.zhou/Desktop/gen3/cancer_data_commons_ver/submission_gene_expression_template.tsv', sep='\t')
...
# print(df.head(5))
df.to_csv('gene_expression_new.tsv', sep='\t', index=False)
